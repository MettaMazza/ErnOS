...
function resolveMemoryToolContext(options: { config?: ErnOSConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: ErnOSConfig): MemoryCitationsMode {
