...
type ModelsConfig = NonNullable<ErnOSConfig["models"]>;
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // ErnOS keeps auth in auth-profiles and resolves runtime availability from that store.
