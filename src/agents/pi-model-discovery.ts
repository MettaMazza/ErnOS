...
function scrubLegacyStaticAuthJsonEntries(pathname: string): void {
  if (process.env.ERNOS_AUTH_STORE_READONLY === "1") {
    return;
  }
...
api["AuthStorage"] = PiAuthStorageClass;
api["ModelRegistry"] = PiModelRegistryClass;
api["discoverAuthStorage"] = discoverAuthStorage;
api["discoverModels"] = discoverModels;
