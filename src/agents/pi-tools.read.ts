...
function resolveAdaptiveReadMaxBytes(options?: ErnOSReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createErnOSReadTool(base, {
...
export function createErnOSReadTool(
  base: AnyAgentTool,
  options?: ErnOSReadToolOptions,
): AnyAgentTool {
