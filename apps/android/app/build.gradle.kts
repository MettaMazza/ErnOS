...
android {
  namespace = "ai.ernos.android"
  compileSdk = 36

  sourceSets {
    getByName("main") {
      assets.directories.add("../../shared/ErnOSKit/Sources/ErnOSKit/Resources")
    }
  }

  defaultConfig {
    applicationId = "ai.ernos.android"
    minSdk = 31
    targetSdk = 36
  ...
  onVariants { variant ->
    variant.outputs
      ...
      .forEach { output ->
        ...
        val outputFileName = "ernos-${versionName}-${buildType}.apk"
